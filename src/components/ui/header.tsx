...
export const Header = () => {
  ...
  return (
    <header className={` ${showMenu?'fixed top-0 z-30 bg-background':''} w-full flex flex-col items-center justify-between`}>
      <div className="hidden py-1 px-5 md:px-0 sm:flex w-full mx-auto justify-between  items-center">
        <Link className="text-xl font-bold leading-[4rem] flex items-center" href="/">
          Paddle Table 2024 <Image className='ml-2' src='/favicon.ico' alt="icono" width={24} height={24} />
        </Link>
        <nav>
      ...
      <div className="px-5 sm:hidden flex flex-row gap-4 py-4 z-30 justify-between w-full items-center">
        <Link onClick={() => setShowMenu(!showMenu)} className="text-xl font-bold leading-[4rem] flex items-center" href="/">
        Paddle Table 2024 <Image className='ml-2' src='/favicon.ico' alt="icono" width={24} height={24} />
        </Link>
